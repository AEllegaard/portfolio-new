<template>
  <div class="w-2/3 pb-12 ">
    ...
    <div class="tekst font-display font-light text-lg md:text-3xl mx-4 mt-20  tracking-tight">
      <h1 class="text-justify">I’m a designer who’s got a solid mix of brains, creativity and real-world experience in agencies and in-house gigs. I love blending good looks with good functionality, making sure things not only look nice but actually work well.

I’m all about owning my projects, working well with others, and picking up new skills fast. Whether it’s creating interactive experiences online or in the real world, my goal is to craft smooth, beautiful experiences that don’t just turn heads but actually make life easier and maybe even a little more fun.</h1>
     
    </div>

    <!--     Work    -->
    <div class="credentials font-display mx-4 mt-30">
      <h1 class=" text-lg md:text-lg font-light tracking-tight">Work</h1>
...
<div class="mt-5 grid grid-cols-4  items-center">
  ...
  <div class="col-span-1">
    ...
    <div class="credentials font-display mx-4 mt-30">
      <h1 class=" text-lg md:text-lg font-light tracking-tight">Press</h1>
...
<div class="mt-5 grid grid-cols-4 items-center">
  ...
  <div class="mx-4">
    <p class="inline-block font-light text-base  pb-10 underline"><a download="Anna_Ellegaard_CV_EN.pdf" href="/public/Media/Anna_Ellegaard_CV_EN.pdf">Download my CV</a></p>
  </div>
